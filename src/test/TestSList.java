package com.jeannius.cs401.project.test;//--------------------------------------------------------------------
//
...
import com.jeannius.cs401.project.RefUnsortedList;
...
class TestSList
{
    public static void main( String [] args ) throws IOException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        RefUnsortedList testList = new RefUnsortedList( );   // A singly linked list
        ...
        do
        {
            ...
            while ( strTokens.hasMoreTokens( ) )
            {
                ...
                case '+' :                                  // insert
                    ...
                    testList.add(new Character(testElement));
                    break;
